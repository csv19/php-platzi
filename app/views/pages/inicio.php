...
<section class="container mx-auto z-10">
  <div class="grid grid-cols-4 mx-auto items-center px-4 w-full lg:w-[1050px]">
    <div class="banner-navidad flex flex-col lg:flex-row gap-4 lg:rounded-l-lg col-span-4 lg:col-span-3 items-center p-4 h-auto lg:h-[60px]">
      <div>
    ...
    <div class="col-span-4 lg:col-span-1  lg:rounded-r-lg flex flex-col items-center justify-center banner-navidad-end h-[60px]">
  ...
  <div class="py-6 text-center text-5xl font-bold leading-snug">
    ...
    <div class="w-[400px] h-[50px] relative mx-auto mb-8">
      <input id="searchInput" placeholder="" type="text" class="searchInput w-full h-full bg-black-opacity rounded-lg border-solid border-2 border-green-600 text-sm px-2 font-light">
      <button class="absolute top-8 right-4" aria-label="Search Icon Btn"><svg class="text-gray-300"
