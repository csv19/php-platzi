...
<head>
  ...
  <link rel="stylesheet" href="http://localhost:8888/php-platzi/public/styles/home.css">
  ...
  <header class="container mx-auto py-4">
    <div class="grid grid-cols-3 gap-4 justify-center items-center">
        ...
        <div class="flex flex-row-reverse">
          <button class="px-3 py-2 rounded-lg bg-white text-black">Acceder</button>
        </div>
    </div>
